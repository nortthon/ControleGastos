...
namespace Entidades
{
    public partial class tb_conta
    {
        ...
        public virtual long cont_id
        {
            get;
            set;
        }
    
        public virtual string cont_nome
        {
            get;
            set;
        }
    
        public virtual string cont_descricao
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.tb_conta.Contains(this))
            {
                previousValue.tb_conta.Remove(this);
            }
    
            if (tb_usuario != null)
            {
                if (!tb_usuario.tb_conta.Contains(this))
                {
                    tb_usuario.tb_conta.Add(this);
                }
        ...
        private void Fixuptb_transacao(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.tb_conta, this))
                    {
                        item.tb_conta = null;
                    }
                }
