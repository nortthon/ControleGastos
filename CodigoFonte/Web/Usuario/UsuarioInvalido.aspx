<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsuarioInvalido.aspx.cs" Inherits="Web.Usuario.UsuarioInvalido" %>
		...
		<div id="pageWrap"><br /><br />
			<div class="boxShadow p10 mAuto" style="width:350px;">
				<p style="text-align:center">
					Os dados de acesso são inválidos.<br />
                    Verifique o Login e Senha estão corretos e tente novamente.
				</p>
